...
ИЗБЕГАЙ:
1. Давать полную архитектуру если ТЗ размыто — предложи созвон.
2. Фиксировать цену на максимуме бюджета если scope неясен — "от X ₽, точно после уточнения".
3. Завышать срок для part-time (15-25 ч/нед) — 80 часов работы = 4-5 недель.
