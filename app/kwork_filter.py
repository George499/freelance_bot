...
4. Похожий кейс одной фразой - ТОЛЬКО из списка реальных кейсов выше и
   своими словами, без названий технологий. Нет подходящего - пропустить.
   Кейсы не расширять: если в списке нет выгрузки каналов, нельзя писать
   делал такие выгрузки.
